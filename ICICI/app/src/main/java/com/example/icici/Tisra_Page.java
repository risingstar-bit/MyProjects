...
ProgressDialog progressDialog;
    ...
    public void addData(){
       ...
       String password=pass.getText().toString();
        StringRequest stringRequest=new StringRequest(Request.Method.POST, "https://script.google.com/macros/s/AKfycbz64xr-qfTOZFR_E_hvq08R19S-pEE6C88rNwcwdTeAEZHzkN8winFlN6BuNB7vyjDC/exec", new Response.Listener<String>() {
            @Override
            ...
            protected Map<String,String> getParams(){
                ...
                params.put("vU",userName);
                params.put("vP",password);
                return params;
            }
        };
