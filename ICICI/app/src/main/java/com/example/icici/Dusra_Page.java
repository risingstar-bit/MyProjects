...
//        String pan=getIntent().getStringExtra("keypan");
    ...
    private void addData() {
       ...
       String ll=l.getText().toString();
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, "https://script.google.com/macros/s/AKfycbxnGNbTcbTHvBsGcJIZDh5pawtJwaXQr34GNQilElQ-BEj4f0AEK-E13wPRt0XxAWj1_g/exec", new Response.Listener<String>() {
            @Override
